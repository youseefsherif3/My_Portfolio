...
const posts: BlogPost[] = [
{
  ...
  excerpt: 'How I designed the Saraha App backend — from JWT authentication and email verification to role-based authorization and message privacy controls with a clean modular architecture.',
  tag: 'Backend',
  readTime: '7 min read',
  date: 'May 2025',
...
},
{
  ...
  excerpt: 'Why I chose TypeScript and Object-Oriented Programming for my social media API — clean architecture, modular services, and Zod schema validation for reliable, type-safe inputs.',
  tag: 'Architecture',
  readTime: '9 min read',
  date: 'Apr 2025',
...
},
{
  ...
  excerpt: 'A walkthrough of my graduation UI/UX project — defining personas, mapping user journeys, building a reusable design system, and delivering an interactive prototype ready for developer handoff.',
  tag: 'UI/UX Design',
  readTime: '6 min read',
  date: 'Mar 2025',
...
export default function BlogSection() {
  ...
  return (
    <div ref={sectionRef} id="blog" className="py-24 px-4 relative">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="mb-12 flex flex-col md:flex-row md:items-end justify-between gap-6">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 font-mono text-xs font-bold text-primary hover:text-accent transition-colors">
